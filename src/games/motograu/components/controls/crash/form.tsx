...
const getBackgroundColor = (color: string) => {
  switch (color) {
    ...
    case 'lime':
      return 'bg-blue-500 hover:bg-green-500'
    case 'amber':
...
export default function CrashForm({
  ...
  return (
    <div className="bg-black border border-gray-600 bg-opacity-20 border-opacity-20 crash-form w-full h-45 md:w-1/2 flex rounded-md p-2 relative">
      <form
        ref={formRef}
        method="POST"
      ...
      >
        ...
        <div className='w-full'>
          <div className='flex items-center gap-2 mb-2'>
            ...
            <If condition={toggleSecond && !secondEnabled}>
              <button
                ...
                className={`btn border-none bg-[#ffffff] bg-opacity-10 btn-xs btn-circle`}
              >
            ...
            <If condition={hideSelf}>
              <button
                onClick={() => hideSelf()}
                className={`btn border-none btn-xs bg-[#ffffff] bg-opacity-10 hover:bg-opacity-95 btn-circle`}
              >
          ...
          <div className='flex gap-2 mb-2'>
            <div className='rounded-md bg-gray-500 bg-opacity-25 w-[60%] px-2 py-2'>
              {/* input valor e btns menores */}
              <div>
                ...
                <div className="w-full">
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-gray-500 bg-opacity-25 rounded-md">
                      <button
                        ...
                        className="btn btn-ghost min-h-0 flex-1 w-full h-full rounded-md text-xl font-extrabold disabled:bg-gray-700 disabled:bg-opacity-30 border-gray-700 border-opacity-40"
                      >
                        &frac12;
                      </button>
                    </div>
                    ...
                    <div className="bg-gray-500 bg-opacity-25 rounded-md">
                      <button
                        ...
                        className="btn btn-ghost min-h-0 grow w-full h-full rounded capitalize text-normal font-extrabold disabled:bg-gray-700 disabled:bg-opacity-30 border-gray-700 border-opacity-40"
                      >
                        2x
                      </button>
                    </div>
            ...
            <div className='w-[40%]'>
              <div className="h-full">
                ...
                >
                  <button
                    className={`btn border-2 border-blue-400 hover:border-green-400 text-[22px] hover:text-[24px] rounded-[20px]  ${getBackgroundColor(
                      color
                    )} flex flex-col px-0 text-white h-full w-full`}
                  >
                    <span className="font-extrabold text-shadow-sm">
